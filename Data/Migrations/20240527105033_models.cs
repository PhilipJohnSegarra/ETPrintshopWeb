    ...
    public partial class models : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequisitionForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RequisitionForms_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CTR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Quantity = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RequisitionItems_RequisitionForms_RequisitionFormId",
                        column: x => x.RequisitionFormId,
                        principalTable: "RequisitionForms",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stocks = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequisitionForms_UserId",
                table: "RequisitionForms",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RequisitionItems_RequisitionFormId",
